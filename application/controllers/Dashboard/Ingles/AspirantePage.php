...
public function index()
{
	...
	//This is the update of methods to have a better performance
	...
	$responseView = $this->_callApiRest('Verano/Ingles/api/aspiranteInglesBYAspirante/id/'.$identAspirante,null,"GET",null);
	// echo var_dump($responseView['data']['statusAspirante']);
	...
	//
		...
		if($responseView['data']['statusAspirante'] == '2R'){
		  ...
		  $data['pasoSiete']	=$pasoSiete;
			...
			$this->load->view('Dashboard_pages/Ingles/aspirante_page_dr_view',$data);
			$this->_finalPageAspirante();
			$this->_finalPage();

		}else if($responseView['data']['statusAspirante'] == '3' OR $responseView['data']['statusAspirante'] == '4U' OR $responseView['data']['statusAspirante'] == '4C'){
			$progreso = '20%';
			// $infoDoc = '';
			// $statusDoc = '';
			// $stepOne = '';
			...
			$this->_finalPageAspirante();
			$this->_finalPage();
		}else if($responseView['data']['statusAspirante'] == '4C' OR 1==2){
			$progreso = '';
			$instOnePago ='';
		...
		//	$responseTipoOfertaInstThree = $this->_callApiRest('Verano/Ingles/api/tipoOferta/id/'.$identAspirante.'/aux/'.$fkInstThree,null,"GET",null);
			...
			$data['numAplicanteThree'] = $responseNumAplicanteThree['data'];
						...
						$this->_initialAspirante($data);
						$this->_headerAdmin($data);
						$this->load->view('Dashboard_pages/Ingles/aspirante_page_cc_view',$data);
						$this->_finalPageAspirante();
						$this->_finalPage();
			...
			$responseDocOne = $this->_callApiRest('Ingles/api/inglesDocForm/id/'.$fkInstOne,null,"GET",null);
			$responseDocTwo = $this->_callApiRest('Ingles/api/inglesDocForm/id/'.$fkInstTwo,null,"GET",null);
			$responseDocThree = $this->_callApiRest('Ingles/api/inglesDocForm/id/'.$fkInstThree,null,"GET",null);

			$responseForm = $this->_callApiRest('Ingles/api/fileIngles/id/'.$identAspirante,null,"GET",null);
			...
			// This is the validations for the status we have three because the person can chose a max of three institution
			...
			//here end the updates June 19 2020
