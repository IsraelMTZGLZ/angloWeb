...
class BecasUP extends MY_RootController {
	...
	public function index()
	{
        ...
        $BecasDocs = $this->_callApiRest('Documentos/BecasUP/api/becas/id/'.$this->session->userdata('user_sess')->aspirante,null,"GET",null);
        $data['BecasDocs'] = $BecasDocs['data'];

        $this->_initialPage($data);
		$this->load->view('Dashboard_pages/Becas/view',$data);
        $this->_finalPage();
        $this->load->view('Dashboard_pages/Becas/viewJS');
