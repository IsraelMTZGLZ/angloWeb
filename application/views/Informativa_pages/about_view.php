...
<!-- counter wrapper end-->
<!-- story Wrapper Start -->
<div class="inner_Story_wrapper story_wrapper_II float_left">
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-md-12 col-12 col-sm-12">
            <div class="cp_heading_wraper left_heading">
...
-->
                    ...
                    <div class="item">
                        <div class="team_slider_main float_left">
                            <div class="team_img_wrapper">
                                <img src="<?=base_url('resources/assets/Anglo/David.jpg');?>" class="img-responsive" alt="img" />
                            </div>
                    ...
                    <div class="item">
                        <div class="team_slider_main float_left">
                            ...
                            <div class="team_img_wrapper">
                                <img src="<?=base_url('resources/assets/Anglo/Gallegos.jpeg');?>" class="img-responsive" alt="img" />
                            </div>
                            <div class="team_info_wrapper">
