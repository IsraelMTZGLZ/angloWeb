<style>.imagentest {filter: saturate(180%);}</style>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        ...
                        <h1><?=$this->lang->line('initial_beca_message');?></h1>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        <div class="sub_title_section">
                            <ul class="sub_title">
                                <li style="text-transform: none"> <?=$this->lang->line('initial_beca_message_two');?></li>
