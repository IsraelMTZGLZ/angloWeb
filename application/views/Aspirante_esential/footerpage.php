  ...
  <div class="card-block">
    ...
    <div class="card-block">
      <div class="text-center">
          <a type="button" class="btn btn-round btn-warning btn-config" href="tel:4422609090"><i class="icon  fa-phone " aria-hidden="true"></i>LLamar</a>
      </div>
      <br>
      <div class="text-center">
          <a type="button" class="btn btn-round  btn-success btn-config" href="tel:4422609090"><i class="icon fa-whatsapp" aria-hidden="true"></i>WhatsApp</a>
      </div>
      <br>
      <div class="text-center">
          <a type="button" class="btn btn-round  btn-danger btn-config" href="tel:4422609090"><i class="icon fa-envelope" aria-hidden="true"></i>Correo</a>
      </div>
      <br>
      <div class="text-center">
          <a type="button" class="btn btn-round  btn-info btn-config" href="tel:4422609090"><i class="icon fa-facebook" aria-hidden="true"></i>Messanger Facebook</a>
      </div>
    </div>
...
<div class="modal fade modal-3d-slit modal-info" id="exampleNifty3dSlit" aria-hidden="true"
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <br>
    <p>
      Para poder aplicar a algun campamento se tiene que descargar los siguientes documentos!.</p>
  </div>
...
<div class="modal fade  modal-info" id="InfoDr" aria-hidden="true"
    aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-simple">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <br>
        <p>
          Espere las indicaciones de un agente se esta subiendo su numero de aplicante.</p>
      </div>
      <div class="modal-footer">
        <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
        <button type="button" class="btn btn-info" data-dismiss="modal">OK</button>
...
<div class="modal fade  modal-info" id="InfoTres" aria-hidden="true"
    aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-simple">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <br>
        <p>
          En los apartados de documentos vas a subir las cartas para cada institucion que se indica, en caso de dudas contactar agente.</p>
      </div>
      <div class="modal-footer">
        <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
        <button type="button" class="btn btn-info" data-dismiss="modal">OK</button>
