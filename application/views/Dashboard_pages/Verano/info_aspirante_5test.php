...
<!-- Mirrored from getbootstrapadmin.com/remark/center/pages/profile-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2020 06:27:39 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/global/vendor/slick-carousel/slick.min599c.css?v4.0.2');?>">

  <!-- Page -->
  <link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/center/assets/examples/css/pages/profile-v2.min599c.css?v4.0.2');?>">
<link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/center/assets/examples/css/uikit/progress-bars.min599c.css?v4.0.2');?>">
<link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/center/assets/examples/css/dashboard/team.min599c.css?v4.0.2');?>">
                ...
                <div class="card card-element">
                    ...
                    <div class="text-center">
                        ...
                        <form class="" action="index.html" method="post">
                          <div class="">
                                <input type="text" name="" value="" placeholder="N">
                          </div>

                          <br>
                          <input type="date" name="" value="" placeholder="Fecha">
                        </form>
                    </div>
                    <br>
                ...
                <div class="example example-buttons">
                  ...
                  <?php if(@$fileexists == TRUE) { ;?>
                    ...
                    <div class="float-left">
                      <button type="button" class="btn btn-primary ladda-button btn-aceptar-visa" data-style="expand-left"
                        data-plugin="ladda" data-type="progress" id="file">
                        <span class="ladda-label"><i class="icon fa-check" aria-hidden="true"></i>Aceptar</span>
                      </button>
                    </div>
                    <div class="float-left">
                      <button type="button" class="btn btn-warning ladda-button btn-rechazar-visa" data-style="expand-left"
                        data-plugin="ladda" data-type="progress" id="file">
                      ...
                      <div class="reviciones example example-popover" align="center">
                        ...
                        <div class="popover bs-popover-bottom popover-warning col-12">
                          ...
                          <div class="popover-body  col-12">
                            <p><b>La visa de <?=@$aspirante['firstNamePersona'];?> <?=@$aspirante['lastNamePersona'];?></b> fue rechazado! </p>
                ...
                <ul class="timeline timeline-icon">
                  <li class="timeline-reverse timeline-item">
                    <div class="timeline-content-wrap">
                      ...
                      <div class="timeline-content">
                        <div class="title">
                          <span class="authors">Status 0</span> Registro en el Sistema
                        </div>
                        <div class="metas">
                  ...
                  <li class="timeline-reverse timeline-item">
                    <div class="timeline-content-wrap">
                      ...
                      <div class="timeline-content">
                        <div class="title">
                          <span class="authors">Status 1</span>Registro de Aspirante
                        </div>
                        <div class="metas">
                          <!-- active 2 hours ago -->
                        </div>
                  ...
                  <li class="timeline-reverse timeline-item">
                    <div class="timeline-content-wrap">
                      ...
                      <div class="timeline-content">
                        <div class="title">
                          <span class="authors">Status 2</span>
                          Subio un archivo
                        </div>
                        <div class="metas">
                          active 4 hours ago
                  ...
                  <li class="timeline-reverse timeline-item">
                    <div class="timeline-content-wrap">
                      ...
                      <div class="timeline-content">
                        <div class="title">
                          <span class="authors">Status 2R</span>
                          Termino de Subir primeros documentos
                        </div>
                        <div class="metas">
                          active 3 hours ago
                        </div>
