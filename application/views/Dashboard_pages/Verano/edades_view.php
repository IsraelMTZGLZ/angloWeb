    ...
    <div class="modal-content">
      ...
      <div class="modal-body form-row">
          ...
          <div class="col-xl-4 form-group">
            <label>Nombre</label>
            <input type="text" class="form-control" name="nombre" id="nombreEdad" placeholder="Nombre">
          </div>
          <div class="col-xl-4 form-group">
            <label>Abreviación</label>
            <input type="text" class="form-control" name="abreviacion" id="abreviacionEdad" placeholder="Nombre">
          </div>

          <div class="col-xl-4 form-group">
            <label>Edad</label>
            <input type="text" class="form-control" name="edad" id="edadEdad" placeholder="Fundación">
          </div>
