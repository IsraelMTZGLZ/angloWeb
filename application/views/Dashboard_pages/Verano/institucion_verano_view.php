              ...
              <div class="col-lg-4">
                <div class="card card-shadow text-center">
                  <div class="card-block">
                    ...
                    <button type="button" class="btn btn-round btn-outline btn-success btn-add-alojamientoInstitucion" id="<?=@$instituciones[$i]['idInstitucion'];?>">Añadir Campamento</button>
                  </div>
