                ...
                <fieldset>
                  ...
                  <?php for ($i = 0; $i < count($edades); $i++) { ?>
                    <li>
                      ...
                      <label for="test<?=@$i+1;?>"><?=@$edades[$i]['nombreEdad'];?></label>
                    </li>
                  <?php } ?>
                  </ul>
                  </div>
                ...
                <fieldset>
                  ...
                  <div class="container">
                    ...
                    <li>
                      ...
                      <label for="te<?=@$i+1;?>"><?=@$alojamientos[$i]['nombreTipoAlojamiento'];?></label>
                    </li>
                      <?php } ?>
                  ...
                  <!-- <input type="submit" class="submit action-button" value="Submit" /> -->
                    <button type="submit" class="btn btn-primary animation-shake ">Continuar</button>
                </fieldset>
              </form>
