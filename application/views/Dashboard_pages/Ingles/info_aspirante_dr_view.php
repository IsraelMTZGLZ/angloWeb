  ...
  <div class="page">
    <div class="page-header">
      <h1 align="center" class="page-title">Cursos de  Ingles  </h1>
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="../index.html">Cursos de Ingles</a></li>
                            ...
                            <div class="example-wrap">
                              ...
                              <div class="example example-buttons">
                                ...
                                <?php if(@$fileexistsPago == TRUE) { ;?>
                                  ...
                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-aceptar-ingles" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon fa-check" aria-hidden="true"></i>Aceptar</span>
                                    </button>
                                  </div>
