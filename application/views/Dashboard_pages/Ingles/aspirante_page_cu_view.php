              ...
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-visaCu-ingles" data-style="expand-left"
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-visaCuTwo-ingles" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-visaCuThree-ingles" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
