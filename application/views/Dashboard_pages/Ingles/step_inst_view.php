    ...
    <div class="row">
        <div class="col-12">
          ...
          <div class="example-wrap">
            <h4 class="example-title" style="color: white;font-size: 30px">¿Dónde te gustaría estudiar?</h4>

            <div class="row">
                <div class="col-lg-5">
                    <div class="example-col">
                        <p style="color: white;font-size: 18px">Selecciona las ciudades de tu interes ( Maximo 3 ):</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12">
                  ...
                  <div class="card">
                    ...
                    <ul class="list-group list-group-dividered px-20 mb-0">
                      <li class="list-group-item px-0"><?=@$instituciones[$i]['abreviacionTipoCurso'];?> <?=@$instituciones[$i]['nombreTipoCurso'];?></li>
                      <li class="list-group-item px-0"><?=@$instituciones[$i]['nombreTipoAlojamiento'];?> <?=@$instituciones[$i]['abreviacionTipoAlojamiento'];?></li>
                    </ul>
