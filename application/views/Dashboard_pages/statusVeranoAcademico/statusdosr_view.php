...
<script>
$(function(){
    _url = _principalURL()+"/Verano/Academico/api/statusDosR";
            ...
            var hash=btoa(response.data[i].idAspirante);
  					_html +="<tr>";
  					        ...
  					        _html +="<td>"+response.data[i].firstNamePersona+"</td>";
  			    				...
  			    				_html +="<td>  <a href='tel:"+response.data[i].telefonoAspirante+"'  class='btn btn-icon btn-danger'  data-toggle='tooltip' title='Information'> <i class='icon fa-phone'></i></a> <a href='<?=base_url('Dashboard/VeranoAcademico/InfoAspiranteDosR/info/')?>"+hash+"' id='btnE"+response.data[i].id+"' class='btn btn-icon btn-warning'  data-toggle='tooltip' title='Information'> <i class='icon fa-eye'></i></a> <a href='https://api.whatsapp.com/send?phone="+response.data[i].telefonoAspirante+"&text=No%subiste%20ningun%20documento'  target='_blank'  class='btn btn-icon btn-success'  data-toggle='tooltip' title='Information'> <i class='icon fa-whatsapp'></i></a> <button  class='btn btn-icon btn-info sendEmail'  data-toggle='tooltip' title='Information'> <i class='icon fa-envelope'></i></button> <a href='<?=base_url('Dashboard/VeranoAcademico/InfoAspiranteDosR/info/')?>"+hash+"' id='btnE"+response.data[i].id+"' class='btn btn-icon btn-primary'  data-toggle='tooltip' title='Information'> <i class='icon fa-edit'></i></a></td>";
  			    				_html +="</tr>";
  				}
