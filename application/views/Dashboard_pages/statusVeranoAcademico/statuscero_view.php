...
<script>
$(function(){
    _url = _principalURL()+"/Verano/Ingles/api/statusCero";
    ...
    console.log("entra");
      ...
      $.ajax({
            ...
            if(response.data[i].generoPersona == ""){
               response.data[i].generoPersona = 'Sin Genero';
              console.log('entra');
            }else{

              console.log(response.data[i].generoPersona);
