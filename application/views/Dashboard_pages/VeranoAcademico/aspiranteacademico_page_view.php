  ...
  <!-- Page -->
    ...
    <input type="hidden" id="idInstitucionThree" value="<?=@$InstThreeInfo;?>" name="idInstitucionThree">
              ...
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-academic-passport" data-style="expand-left"
          ...
          <div class="user-background card card-shadow">
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example">
                  <form id="formOneAcademico">
                    <input type="file" id="input-academico-file-FormOne" name="formatoDeSolicitud.pdf" data-plugin="dropify" <?=$enableFormOne;?>   data-default-file="<?=$defaultfileFormOne;?>"/>
                  </form>
                </div>
                <div class="example example-buttons">
                  <?php if(@$fileexistsFormOne == FALSE) { ;?>
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-academic-formRegistrationOne" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-warning ladda-button btn-edit-file-academic-formRegistrationOne" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                    </button>
                  </div>
          ...
          <div class="user-background card card-shadow">
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example">
                  <form id="formAcademicoTwo">
                    <input type="file" id="input-academicofile-FormTwo" name="formatoDeSolicitud.pdf" data-plugin="dropify" <?=$enableFormTwo;?>   data-default-file="<?=$defaultfileFormTwo;?>"/>
                  </form>
                </div>
                <div class="example example-buttons">
                  <?php if(@$fileexistsFormTwo == FALSE) { ;?>
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-academic-formRegistrationTwo" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-warning ladda-button btn-edit-file-academic-formRegistrationTwo" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                    </button>
                  </div>
          ...
          <div class="user-background card card-shadow">
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example">
                  <form id="formDocAcademicThree">
                    <input type="file" id="input-academicfile-FormThree" name="formatoDeSolicitud.pdf" data-plugin="dropify" <?=$enableFormThree;?>   data-default-file="<?=$defaultfileFormThree;?>"/>
                  </form>
                </div>
                <div class="example example-buttons">
                  <?php if(@$fileexistsFormThree == FALSE) { ;?>
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-academic-formRegistrationThree" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-warning ladda-button btn-edit-file-academic-formRegistrationThree" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                    </button>
                  </div>
          ...
          <div class="user-background card card-shadow">
            ...
            <div class="card-block">
              <div class="example-wrap">
                <h4 class="example-title"><?=$infoTranscription;?></h4>
                <div class="example">
                  <form id="formTranscription">
                    <input type="file" id="input-file-transcription" name="Transcription.pdf" data-plugin="dropify" <?=$enableTranscription;?>   data-default-file="<?=$defaultTranscription;?>" />
                  </form>
                </div>
                <div class="example example-buttons">
                  <?php if(@$Transcriptionexists== FALSE) { ;?>
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-academic-transcription" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
                  <?php } ;?>
                  <?php if(@$Transcriptionexists == TRUE and $fileInfoTranscription['data']['statusDocumento']== 'Rechazado') { ;?>
                  <div class="float-left">
                    <button type="button" class="btn btn-warning ladda-button btn-edit-file-academic-transcription" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                    </button>
                  </div>
                  ...
                  <div class="example">
                    <div class="pearls row">
                      <div class="pearl <?=@$stepOneT;?> col-4">
                        <div class="pearl-icon"><i class="icon wb-upload  upicon" aria-hidden="true"></i></div>
                        <span class="pearl-title">Cargar Pasaporte</span>
                      </div>
                      <div class="pearl <?=@$stepTwoT;?> col-4">
                        <div class="pearl-icon"><i class="icon fa-spinner upicon " aria-hidden="true"></i></div>
                        <span class="pearl-title">Revisión</span>

                        <?php if(@$fileInfoTranscription['data']['statusDocumento']== 'Revision') { ;?>
                        <div class="reviciones example example-popover" align="center">
                          <button type="button" class="btn btn-info sr-only">
                            Documento en revisión
                          </button>
                      ...
                      <div class="pearl <?=@$stepThreeT;?> col-4">
                        <div class="pearl-icon"><i class="icon wb-check upicon" aria-hidden="true"></i></div>
                        <span class="pearl-title">Aceptado</span>
                      </div>
                    </div>
              ...
              <div class="card-header card-header-transparent p-20">
                <h4 class="card-title mb-0">Traducción al inglés </h4>
              </div>
              <div class="card-block">
                <div class="example-wrap">
                  <h4 class="example-title"><?=$infoTraduction;?></h4>
                  <div class="example">
                    <form id="formTraduction">
                      <input type="file" id="input-file-traduction" name="Transcription.pdf" data-plugin="dropify" <?=$enableTraduction;?>   data-default-file="<?=$defaultTraduction;?>" />
                    </form>
                  </div>
                  <div class="example example-buttons">
                      <?php if(@$Traductionexists== FALSE) { ;?>
                    <div class="float-left">
                      <button type="button" class="btn btn-primary ladda-button btn-file-academic-traduction" data-style="expand-left"
                        data-plugin="ladda" data-type="progress" id="file">
                        <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                      </button>
                    </div>
                    <?php } ;?>
                    <?php if(@$Traductionexists == TRUE and $fileInfoTraduction['data']['statusDocumento']== 'Rechazado') { ;?>
                    <div class="float-left">
                      <button type="button" class="btn btn-warning ladda-button btn-edit-file-academic-traduction" data-style="expand-left"
                        data-plugin="ladda" data-type="progress" id="file">
                        <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                      </button>
                    </div>
                    ...
                    <div class="example">
                      <div class="pearls row">
                        ...
                        <div class="pearl <?=@$stepTwoTraduction;?> col-4">
                          ...
                          <?php if(@$fileInfoTraduction['data']['statusDocumento']== 'Revision') { ;?>
                          <div class="reviciones example example-popover" align="center">
                            <button type="button" class="btn btn-info sr-only">
                              Documento en revisión
                            </button>
