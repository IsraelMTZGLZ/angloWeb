  ...
  <div class="page">
    <div class="page-header">
      <h1 align="center" class="page-title">Cursos de  Verano Academico </h1>
    ...
    <div class="page-content container-fluid">
      <div class="row">
        ...
        <!-- End Middle Column -->
        <?php if(@$NumAplicantOne !=NULL OR @$NumAplicantTwo !=NULL OR @$NumAplicantThree !=NULL ) { ;?>
                            ...
                            <div class="card-block">
                              ...
                              <?php }else if(@$fileInfoCartaInstOne['data'][0]['type']== 'OfertaIncondicional'){ ;?>
                                ...
                                <?php if(@$fileexistsCartaInstOne == FALSE) { ;?>
                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-file-carta-vacademicoagente-One" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                            ...
                            <div class="card-block">
                              ...
                              <?php }else if(@$fileInfoCartaInstTwo['data'][0]['type']== 'OfertaIncondicional'){ ;?>
                                ...
                                <?php if(@$fileexistsCartaInstTwo == FALSE) { ;?>
                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-file-carta-vacademicoagente-Two" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                    </button>
                                  </div>
                  ...
                  <?php if(@$InstThreeInfo!= NULL and $NumAplicantThree !=NULL ) { ;?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="user-background card card-shadow">
                            <div class="card-header card-header-transparent p-20">
                              <input type="input" name="idCartaThree" id="idCartaThree" value="<?=@$idCartaThree;?>">
                                  ...
                                  <?php if(@$fileexistsCartaInstThree == TRUE and @$whoCartaInstThree != 'Admin_Agente' and $fileInfoCartaInstThree['data'][0]['statusDocumento']!= 'Aceptado') { ;?>
                                    ...
                                    <div class="float-left">
                                      <button type="button" class="btn btn-warning ladda-button btn-rechazar-verano-vinglesthree" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon fa-times " aria-hidden="true"></i>Rechazaar</span>
                                      </button>
                                    </div>
      ...
      <?php if(@$aspirante['statusAspirante']== '4C' OR @$aspirante['statusAspirante']== '4U'  OR @$aspirante['statusAspirante']== '5') { ;?>
                    ...
                    <div class="col-md-4">
                      <div class="card card-element">
                        <div class="container" style="width:400px;">
                          ...
                          <div class="card-block">
                            <h4 class="card-title" align="center">Documentos</h4>
                            <p class="card-text" align="center"></p>
                          </div>
                            <div class="text-center">
                                <form id="FormAplicantNumber">
                                  <div class="form-group col-md-12">
                                    ...
                                    <div class="text-center">
                                        <p>En este apartado se podra ver y revisar los documentos que el aspirante de de alta, el nombre del documento viene con el nombre que el aspirante puso al momento de dar de alta este documento</p>
                                    </div>
                                  </div>
                                </form>
                            </div>
                      ...
                      <div class="col-md-8">
                        <?php for ($i = 0; $i < count($documentosAcademico); $i++) { ?>
                          ...
                          <div class="user-background card card-shadow">
                            <div class="card-header card-header-transparent p-20">
                              <h4 class="card-title mb-0"> <?=@$documentosAcademico[$i]['nombreDocumento'];?> </h4>
                              <input type="hidden" name="nombreDocumento" id="nombreDocumento" value="<?=@$documentosAcademico[$i]['nombreDocumento'];?>">
                              <input type="hidden" name="extencionDocumento" id="extencionDocumento" value="<?=@$documentosAcademico[$i]['extDocumento'];?>">
                            </div>
                            <div class="card-block">
                              <div class="example-wrap">
                                <h4 class="example-title"><?=@$documentosAcademico[$i]['statusDocumento'];?></h4>
                                <div class="example">
                                  <input type="file" id="input-file-documents" name="<?=@$documentosAcademico[$i]['nombreDocumento'];?><?=@$documentosAcademico[$i]['extDocumento'];?>" data-plugin="dropify" disabled="disabled"  data-default-file="<?=@$documentosAcademico[$i]['urlDocumento'];?>"
                                  />
                                ...
                                <div class="example example-buttons">
                                    ...
                                    <div class="float-left">
                                      <button type="button" id="<?=@$documentosAcademico[$i]['idDocumento'];?>" class="btn btn-primary ladda-button btn-aceptar-academico-documentos" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon fa-check" aria-hidden="true"></i>Aceptar</span>
                                      </button>
                                    </div>
                                    <div class="float-left">
                                      <button type="button" id="<?=@$documentosAcademico[$i]['idDocumento'];?> <?=@$documentosAcademico[$i]['nombreDocumento'];?> <?=@$documentosAcademico[$i]['extDocumento'];?>" class="btn btn-warning ladda-button btn-rechazar-academico-documentos" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon fa-times " aria-hidden="true"></i>Rechazar</span>
                                      </button>
                                    </div>
                                    ...
                                    <div class="float-right">
                                      ...
                                      <a type="button" class="btn btn-primary ladda-button "  href="<?=@$documentosAcademico[$i]['urlDocumento'];?>" target="_blank"> </i>Ver </a>
                                    </div>
                                ...
                                <!-- <div class="example">
                                  <div class="pearls row">
                                    <div class="pearl <?=@$stepOneExamen;?> col-4">
                                      <div class="pearl-icon"><i class="icon wb-upload  upicon" aria-hidden="true"></i></div>
                                      <span class="pearl-title">Cargar Examen</span>
                                    </div>
                        ...
                        <!-- <div class="user-background card card-shadow">
                          ...
                          <div class="card-block">
                            <div class="example-wrap">
                              ...
                              <div class="example">
                                <input type="file" id="input-file-now" data-plugin="dropify" <?=$enableExamen;?>   data-default-file="<?=$defaultfileExamen;?>"
                                />

                              </div>
                              <div class="example example-buttons">

                                <?php if(@$fileexistsExamen == TRUE) { ;?>

                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-aceptar-academico" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon fa-check" aria-hidden="true"></i>Aceptar</span>
                                    </button>
                                  </div>
                                  ...
                                  <div class="float-right">
                                    ...
                                    <a type="button" class="btn btn-primary ladda-button "  href="<?=$defaultfileExamen;?>" target="_blank"> </i>Ver </a>
                                  </div>
                              ...
                              <div class="example-wrap">
                                ...
                                <div class="example example-buttons">
                                  ...
                                  <?php if(@$fileexistsVisa == TRUE and @$fileInfoVisa['data'][0]['statusDocumento']!= 'Aceptado') { ;?>
                                    ...
                                    <div class="float-left">
                                      <button type="button" class="btn btn-primary ladda-button btn-aceptar-visa-academico" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon fa-check" aria-hidden="true"></i>Aceptar</span>
                                      </button>
                                    </div>
                                    <div class="float-left">
                                      <button type="button" class="btn btn-warning ladda-button btn-rechazar-visa-academico" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon fa-times " aria-hidden="true"></i>Rechazar</span>
                                      </button>
                                    </div>
