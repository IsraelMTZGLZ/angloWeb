  ...
  <input type="hidden" name="idCartaThree" id="idCartaThree" value="<?=@$idCartaThree;?>">
          ...
          <!-- User Background -->
          <?php if(!@$InstOneInfo== NULL and 1==2) { ;?>
          ...
          <?php } ;?>
          <?php if(!@$InstTwoInfo== NULL  and 1==2) { ;?>
          <div class="user-background card card-shadow">
            <div class="card-header card-header-transparent p-20">
          ...
          <?php } ;?>
          <?php if(!@$InstThreeInfo== NULL  and 1==2) { ;?>
          <div class="user-background card card-shadow">
            <div class="card-header card-header-transparent p-20">
            ...
            <div class="card-block">
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="float-left">
                    <button type="button" class="btn btn-primary ladda-button btn-file-carta-vacademico-three" data-style="expand-left"
                      data-plugin="ladda" data-type="progress" id="file">
                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                    </button>
                  </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php if(@$InstOneInfo!= NULL and $NumAplicantOne !=NULL ) { ;?>
                    <div class="text-center">
                      <h3 class="card-title mb-0">Alta carta de oferta para <?=@$instOne['nombreInstitucion'];?>  </h3>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="card-block">
                              <div class="example-wrap">
                                ...
                                <div class="example example-buttons">
                                  <?php if(@$fileexistsCartaInstOne == FALSE) { ;?>
                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-file-carta-vacademico" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                    </button>
                                  </div>
                                  ...
                                  <?php if(@$fileexistsCartaInstOne == TRUE and $fileInfoCartaInstOne['data'][0]['statusDocumento']== 'Rechazado') { ;?>
                                  <div class="float-left">
                                    <button type="button" class="btn btn-warning ladda-button btn-edit-file-carta-vacademico" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                                    </button>
                                  </div>
                      ...
                      <?php if(@$InstTwoInfo!= NULL and $NumAplicantTwo !=NULL ) { ;?>
                        ...
                        <div class="row">
                                ...
                                <div class="card-block">
                                  <div class="example-wrap">
                                    ...
                                    <div class="example example-buttons">
                                      <?php if(@$fileexistsCartaInstTwo == FALSE) { ;?>
                                      <div class="float-left">
                                        <button type="button" class="btn btn-primary ladda-button btn-file-carta-vacademico-two" data-style="expand-left"
                                          data-plugin="ladda" data-type="progress" id="file">
                                          <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                        </button>
                                      </div>
                                      ...
                                      <?php if(@$fileexistsCartaInstTwo == TRUE and $fileInfoCartaInstTwo['data'][0]['statusDocumento']== 'Rechazado') { ;?>
                                      <div class="float-left">
                                        <button type="button" class="btn btn-warning ladda-button btn-edit-file-carta-vacademico-two" data-style="expand-left"
                                          data-plugin="ladda" data-type="progress" id="file">
                                          <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                                        </button>
                                      </div>
                          ...
                          <?php if(@$InstThreeInfo!= NULL and $NumAplicantThree !=NULL ) { ;?>
                              <div class="text-center">
                                 <h3 class="card-title mb-0">Alta carta de oferta paraa <?=@$instThree['nombreInstitucion'];?>  </h3>
                              </div>
                              <div class="row">
                              <div class="col-md-4">
                              ...
                              <div class="card card-element">
                                ...
                                <div class="text-center">
                                        ...
                                        <div class="form-group col-md-12">
                                          <label class="form-control-label" for="inputBasicFirstName">Número la aplicante</label>
                                            ...
                                            <input type="number"   name="NumberAplicantVInglesThree" id="NumberAplicantVInglesThree" value="<?=@$numAplicanteThree['numeroAplicante'];?>"  class="form-control text-center"   autocomplete="off" disabled/>
                                             ...
                                             <label class="form-control-label" for="inputBasicFirstName">Fecha de registro</label>
                                              <input type="text"   name="NumberAplicantVInglesThree" id="NumberAplicantVInglesThree" value="<?=@$numAplicanteThree['CD'];?>"  class="form-control form-control text-center"   autocomplete="off" disabled/>
                                            </div>
                                    </form>
                                  </div>
                                  <br>
                                  ...
                                  <div class="example example-buttons">
                                    ...
                                    <?php if(@$fileexistsCartaInstThree == TRUE and $fileInfoCartaInstThree['data'][0]['statusDocumento']== 'Rechazado') { ;?>
                                    <div class="float-left">
                                      <button type="button" class="btn btn-warning ladda-button btn-edit-file-carta-vacademico-three" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                                      </button>
                                    </div>
        ...
        <?php if(@$aspirante['statusAspirante']== '4U'  OR @$aspirante['statusAspirante']== '5' OR @$aspirante['statusAspirante']== '4C') { ;?>

            <div class="col-lg-12 col-xl-6 order-xl-5">
                  ...
                  <div class="card user-visitors">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                            <?php for ($i = 0; $i < count(@$documentosAcademico); $i++) { ?>

                              <!-- $date = date_create() -->
                              <!-- <?= $newDate = DateTime::createFromFormat("l dS F Y", @$documentosAcademico[$i]['lastUpdateDocumento']);?> -->
                              <ul class="list-group list-group-gap">
                                <li class="list-group-item list-group-item-warning"><?=@$documentosAcademico[$i]['nombreDocumento'];?> <br> <label for="">Ultima fecha de modificación: <?=$newDate = date("Y-m-d", strtotime(@$documentosAcademico[$i]['lastUpdateDocumento']));?></label> <span class="badge badge-pill badge-warning">status: <?=@$documentosAcademico[$i]['statusDocumento'];?></span></li>
                      ...
                      <!-- <li class="list-group-item">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="text-center">
                              <h5 class="mt-0 mb-5 hover"></i><?=@$documentosAcademico[$i]['nombreDocumento'];?>
                              </h5>
                            </div>
                          </div>
                          <div class="float-right">
                            <a type="button" class="btn btn-primary btn-xs ladda-button "  href="<?=@$documentosAcademico[$i]['urlDocumento'];?>" download> <i class="icon icon-xs fa-download mr-0" aria-hidden="true"></i> </a>
                          </div>
        ...
        <?php if(@$aspirante['statusAspirante']== '4C' OR @$aspirante['statusAspirante']== '4U') { ;?>

          <div class="col-lg-12 col-xl-6  order-xl-6">
            <div class="card user-visitors">
              <div class="card-header card-header-transparent p-20">
                <h4 class="card-title mb-0">Documentos para aplicacion de visa</h4>
              </div>
              <div class="container-fluid">
              <div class="row">
                              ...
                              <div class="example-wrap">
                                ...
                                <div class="example">
                                  ...
                                  <form id="formReferencia">
                                    ...
                                    <input type="file" id="input-file-documentos" name="Referencia.pdf" data-plugin="dropify"  data-default-file="<?=@$referenciaPago['tipo'];?>"  />
                                  </form>
                                </div>
                                <div class="example example-buttons">
                                  <?php if(@$referenciaPago['data'] ==NULL) { ;?>
                                  <div class="float-left">
                                    <button type="button" class="btn btn-primary ladda-button btn-file-verano-academico-documentos" data-style="expand-left"
                                      data-plugin="ladda" data-type="progress" id="file">
                                      <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                    </button>
                                  </div>
        ...
        <?php if(@$aspirante['statusAspirante']== '4U'  OR @$aspirante['statusAspirante']== '5' ) { ;?>
            ...
            <div class="col-lg-12 col-xl-12 order-xl-7">
              <div class="card user-visitors">
                <div class="card-header card-header-transparent p-20">
                                ...
                                <div class="text-center">
                                    <form id="FormAplicantNumber">
                                      <div class="form-group col-md-12">
                                        ...
                                        <div class="text-center">
                                            <p>En este apartado se dara de alta la visa para poder continuar con el proceso</p>
                                        </div>
                                      </div>
                                    </form>
                                </div>
                              ...
                              <div class="card-block">
                                <div class="example-wrap">
                                  ...
                                  <div class="example example-buttons">
                                    ...
                                    <div class="float-left">
                                      <button type="button" class="btn btn-primary ladda-button btn-file-visa-academico" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                      </button>
                                    </div>
                                    ...
                                    <div class="float-left">
                                      <button type="button" class="btn btn-warning ladda-button btn-edit-visa-academico" data-style="expand-left"
                                        data-plugin="ladda" data-type="progress" id="file">
                                        <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                                      </button>
                                    </div>
        ...
        <?php } ?>
        <!-- <div class="col-lg-12 col-xl-4 order-xl-6">
          <div class="card user-visitors">
            <div class="card-header card-header-transparent p-20">
              <h4 class="card-title mb-0">Documentos para aplicacion de visa</h4>
            </div>
                ...
                <div class="col-md-12">
                  <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="user-background card card-shadow">
                          <div class="card-header card-header-transparent p-20">
                            <h4 class="card-title mb-0">examen ingles vigente </h4>
                          </div>
                          <div class="card-block">
                            <div class="example-wrap">
                              <h4 class="example-title"><?=$infoDocExamen;?></h4>
                              <div class="example">
                                <form id="formDocExamen">
                                  <input type="file" id="input-file-examen" name="Examen.pdf" data-plugin="dropify" <?=$enableExamen;?>   data-default-file="<?=$defaultfileExamen;?>" />
                                </form>
                              </div>
                              <div class="example example-buttons">
                                <?php if(@$fileexistsExamen == FALSE) { ;?>
                                <div class="float-left">
                                  <button type="button" class="btn btn-primary ladda-button btn-file-examen-academico" data-style="expand-left"
                                    data-plugin="ladda" data-type="progress" id="file">
                                    <span class="ladda-label"><i class="icon wb-upload mr-10" aria-hidden="true"></i>Subir</span>
                                  </button>
                                </div>
                                <?php } ;?>
                                <?php if(@$fileexistsExamen == TRUE and $fileInfoExamen['data'][0]['statusDocumento']== 'Rechazado') { ;?>
                                <div class="float-left">
                                  <button type="button" class="btn btn-warning ladda-button btn-edit-file-academico" data-style="expand-left"
                                    data-plugin="ladda" data-type="progress" id="file">
                                    <span class="ladda-label"><i class="icon wb-upload " aria-hidden="true"></i>Volver a subir</span>
                                  </button>
                                </div>
                                ...
                                <div class="example">
                                  <div class="pearls row">
                                    <div class="pearl <?=@$stepOneExamen;?> col-4">
                                      <div class="pearl-icon"><i class="icon wb-upload  upicon" aria-hidden="true"></i></div>
                                      <span class="pearl-title">Cargar Pasaporte</span>
                                    </div>
                                    <div class="pearl <?=@$stepTwoExamen;?> col-4">
                                      <div class="pearl-icon"><i class="icon fa-spinner upicon " aria-hidden="true"></i></div>
                                      <span class="pearl-title">Revisión</span>

                                      <?php if(@$fileInfoExamen['data']['statusDocumento']== 'Revision') { ;?>
                                      <div class="reviciones example example-popover" align="center">
                                        <button type="button" class="btn btn-info sr-only">
                                          Documento en revisión
                                        </button>
                                      ...
                                      <?php } ;?>
                                      <?php if(@$fileInfoExamen['data'][0]['statusDocumento']== 'Rechazado') { ;?>
                                      <div class="reviciones example example-popover" align="center">
                                        ...
                                        <div class="popover bs-popover-bottom popover-warning col-12">
                                          ...
                                          <div class="popover-body  col-12">
                                            <p><b><?=@$aspirante['firstNamePersona'];?> <?=@$aspirante['lastNamePersona'];?></b>su documento fue rechazado. </p>
                                            <p><b>razón: </b> <?=@$descriptionExamen;?></p>
                                          </div>
                                        </div>
                                      </div>
                                      <?php } ;?>
                                    </div>
                                    <div class="pearl <?=@$stepThreeExamen;?> col-4">
                                      <div class="pearl-icon"><i class="icon wb-check upicon" aria-hidden="true"></i></div>
                                      <span class="pearl-title">Aceptado</span>
                                    </div>
                                  </div>
