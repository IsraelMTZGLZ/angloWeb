...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/asscrollable/asScrollable.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/switchery/switchery.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/intro-js/introjs.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/slidepanel/slidePanel.min599c.css?v4.0.2');?>">
  ...
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/chartist/chartist.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/jvectormap/jquery-jvectormap.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min599c.css?v4.0.2');?>">
  ...
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/bootstrap-select/bootstrap-select.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/icheck/icheck.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/ionrangeslider/ionrangeslider.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/asspinner/asSpinner.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/clockpicker/clockpicker.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/ascolorpicker/asColorPicker.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/bootstrap-touchspin/bootstrap-touchspin.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/jquery-labelauty/jquery-labelauty.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/bootstrap-datepicker/bootstrap-datepicker.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/bootstrap-maxlength/bootstrap-maxlength.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/timepicker/jquery-timepicker.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/jquery-strength/jquery-strength.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/multi-select/multi-select.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/typeahead-js/typeahead.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-bs4/dataTables.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-fixedheader-bs4/dataTables.fixedheader.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-fixedcolumns-bs4/dataTables.fixedcolumns.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-rowgroup-bs4/dataTables.rowgroup.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-scroller-bs4/dataTables.scroller.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-select-bs4/dataTables.select.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-responsive-bs4/dataTables.responsive.bootstrap4.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/vendor/datatables.net-buttons-bs4/dataTables.buttons.bootstrap4.min599c.css?v4.0.2');?>">
  ...
  <link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/center/assets/examples/css/pages/register-v3.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" href="<?=base_url('resources/assets/Dashboard/center/assets/examples/css/forms/masks.min599c.css?v4.0.2');?>">
  ...
  <link rel='stylesheet' type="text/css"href="<?=base_url('resources/assets/Dashboard/fonts.googleapis.com/cssade9.css?family=Roboto:300,400,500,300italic');?>">

  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/fonts/weather-icons/weather-icons.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/fonts/font-awesome/font-awesome.min599c.css?v4.0.2');?>">
  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/global/fonts/themify/themify.min599c.css?v4.0.2');?>">

  <link rel="stylesheet" type="text/css" href="<?=base_url('resources/assets/Dashboard/center/assets/css/botones_sociales.css');?>">
  <!-- Scripts -->
...
@keyframes animStar {
        ...
        <div class="col-12">
          ...
          <div class="example-wrap">
            ...
            <div class="card-deck">
              ...
              <div class="card bg-primary card-universidad" style="box-shadow: 0 5px 15px 2px #f3f7f9">
      ...
      <footer class="page-copyright page-copyright-inverse">
        ...
        <div class="social d-none d-sm-block">
          <a class="btn btn-icon btn-pure" href="https://api.whatsapp.com/send?phone=524423645384&text=Quiero%20informacion%20para%20estudiar%20en%20Reino%20Unido" target="_blank">
            <i style="color: white;" class="fab fa-whatsapp" aria-hidden="true"></i>
          </a>
  ...
  <script>
    $(function(){
      ...
      $(document).on('click','.card-universidad',function(){
        removerClase();
          ...
          if ($universidad) {
            ...
            //ingles
            $(document).find('.card-ingles').removeClass('bg-warning').css('box-shadow','0 5px 15px 2px #f3f7f9');
            $ingles=true;

            //verano
            $(document).find('.card-verano').removeClass('bg-warning').css('box-shadow','0 5px 15px 2px #f3f7f9');
            $verano=true;
          }else{
            $(this).removeClass('bg-warning').css('box-shadow','0 5px 15px 2px #f3f7f9');
            $universidad=true;
            $(document).find('#institucion').val('');
          }

      });

      $(document).on('click','.card-preparatoria',function(){
        removerClase();
          if ($preparatoria) {
              //preparatoria activa
            $(this).addClass('bg-warning').css('box-shadow','0 5px 15px 8px yellow');
      ...
      $(document).on('click','.card-ingles',function(){
        removerClase();
          if ($ingles) {
            //ingles activa
            $(this).addClass('bg-warning').css('box-shadow','0 5px 15px 8px yellow')
      ...
      $(document).on('click','.card-verano',function(){
        removerClase();
          if ($verano) {
            //verano activa
            $(this).addClass('bg-warning').css('box-shadow','0 5px 15px 8px yellow')
