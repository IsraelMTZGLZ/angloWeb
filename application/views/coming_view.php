...
<body>
	...
	<div class="main-area">
		...
		<section class="right-section full-height">
			...
			<a class="logo" href="#" style="height: 70px;"><img src="<?=base_url()?>resources/assets/Anglo/AngloLatino-sintexto.png" alt="Logo"></a>
			
			<div class="display-table">
				<div class="display-table-cell">
					<div class="main-content">
						<h1 class="title"><b>Bajo Construccion</b></h1>
			...
			<ul class="footer-icons">
				<li>Contactanos : </li>
				<li><a href="#"><i class="ion-social-facebook" style="font-size: 30px;margin: 10px;"></i></a></li>
