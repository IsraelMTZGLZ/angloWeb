	...
	<div class="main-area">
		...
		<section class="right-section full-height">
			...
			<ul class="footer-icons">
				<li>Contactanos : </li>
				<li><a href="https://www.facebook.com/AngloLatino/" target="_blank"><i class="ion-social-facebook" style="font-size: 30px;margin: 10px;"></i></a></li>
				<li><a href="https://api.whatsapp.com/send?phone=524423645384&text=Quiero%20informacion%20para%20estudiar%20en%20Reino%20Unido" target="_blank"><i class="ion-social-whatsapp" style="color: #25d366;font-size: 30px;margin: 10px;"></i></a></li>
				<li><a href="https://www.linkedin.com/company/anglo-latino-education-partnership-limited" target="_blank"><i class="ion-social-linkedin" style="font-size: 30px;margin: 10px;color: #007bb5;"></i></a></li>
				<li><a href="https://www.instagram.com/anglolatino__/?hl=es-la" target="_blank"><i class="ion-social-instagram-outline" style="font-size: 30px;margin: 10px;"></i></a></li>
				<li><a href="https://twitter.com/angloedu" target="_blank"><i class="ion-social-twitter" style="font-size: 30px;margin: 10px;"></i></a></li>
			</ul>
