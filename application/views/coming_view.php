...
<script>
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:1762491,hjsv:6};
			...
			<div class="display-table">
				<div class="display-table-cell">
					<div class="main-content">
						<h1 class="title" style="font-size: 30px;"><b>Coming soon</b></h1>
						<p>Nuesto sitio web esta en contruccion, <strong> !Gracias por tu confianza! </strong> en unos momentos un asesor se pondra en contacto con tigo, si lo deseas utiliza alguna de nuestras redes sociales para ponerte en contacto con un asesor.<span style="color:black;">Si es posible llena el formulario de hotjar, que aparece en el lado inferior izquierdo.</span></p>
