  ...
  <nav class="site-navbar navbar navbar-default navbar-inverse navbar-fixed-top navbar-mega"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="<?=base_url('resources/assets/Dashboard/center/assets/images/logo.png');?>" title="Remark">
      </div>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                    ...
                    <ul class="blocks-3">
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-1-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-2-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-3-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-4-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-5-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="<?=base_url('resources/assets/Dashboard/global/photos/view-6-150x100.jpg');?>" alt="..." />
                        </a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-online">
                            <img src="<?=base_url('resources/assets/Dashboard/global/portraits/2.jpg');?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-off">
                            <img src="<?=base_url('resources/assets/Dashboard/global/portraits/3.jpg');?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="<?=base_url('resources/assets/Dashboard/global/portraits/4.jpg');?>" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
        ...
        <div class="navbar-brand navbar-brand-center">
          <a href="index.html">
            <img class="navbar-brand-logo navbar-brand-logo-normal" src="<?=base_url('resources/assets/Dashboard/center/assets/images/logo.png');?>"
              title="Remark">
            <img class="navbar-brand-logo navbar-brand-logo-special" src="<?=base_url('resources/assets/Dashboard/center/assets/images/logo-colored.png');?>"
              title="Remark">
          </a>
        </div>
      </div>
