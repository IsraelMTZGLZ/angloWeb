<div class="site-menubar">
    <div class="site-menubar-header">
      <div class="cover overlay">
        <img class="cover-image" src="<?=base_url('resources/assets/Dashboard/center/assets/examples/images/dashboard-header.jpg');?>" alt="...">
        <div class="overlay-panel vertical-align overlay-background">
          <div class="vertical-align-middle">
            <a class="avatar avatar-lg" href="javascript:void(0)">
              <img src="<?=base_url('resources/assets/Dashboard/global/portraits/1.jpg');?>" alt="">
            </a>
            <div class="site-menubar-info">
              <h5 class="site-menubar-user">Machi</h5>
              <p class="site-menubar-email"><a href="https://getbootstrapadmin.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7f121e1c17161b1a0c1618113f18121e1613511c1012">[email&#160;protected]</a></p>
            </div>
          </div>
        </div>
      </div>
