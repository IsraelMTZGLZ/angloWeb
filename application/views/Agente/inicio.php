            ...
            <div class="listar-feature-block-content-wrapper">
              ...
              <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                ...
                <div class="listar-feature-item-excerpt">
                  Atencion personalizada para cada aspirante dependiendo de tus permisos
                </div>
          ...
          <div class="listar-feature-item-inner">
            ...
            <div class="listar-feature-block-content-wrapper">
              <div class="listar-feature-icon-wrapper">
                <div class="listar-feature-icon-inner">
                  <div>
                    <img alt="Customers" class="listar-image-icon" src="<?=@($user->photoUrl!='NULL') ? @$user->photoUrl : base_url("resources/assets/Anglo/AngloLatino-sintexto.png") ;?>">
                  </div>
                </div>
              </div>
              ...
              <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                ...
                <div class="listar-feature-item-excerpt">
                  Edita tu informacion para mostrar una atencion mas personalizada.
                  <br>
                  <strong>!Gracias!</strong> <?=@$user->fullname;?> 
                </div>
          ...
          <div class="listar-feature-item-inner">
            ...
            <div class="listar-feature-block-content-wrapper">
              ...
              <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                ...
                <div class="listar-feature-item-title listar-feature-counter-added">
                  <span><span>03</span>
                    Retro Alimentacion </span>
                </div>

                <div class="listar-feature-item-excerpt">
                  Retro alimentacion de los aspirantes atendidos por ti. </div>
